...
namespace mongo
{
    ...
    {
        RTreeNearClusterClientCursorImpl(const RTreeNearClusterClientCursorImpl &) = delete;
        RTreeNearClusterClientCursorImpl &operator=(const RTreeNearClusterClientCursorImpl &) = delete;
    ...
    public:
         ...
         */
        RTreeNearClusterClientCursorImpl(OperationContext *opCtx,
                                         std::unique_ptr<RouterExecStage> root,
                                         ClusterClientCursorParams &&params,
        ...
        ~RTreeNearClusterClientCursorImpl() final;
