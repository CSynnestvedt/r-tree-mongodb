...
namespace mongo
{
    ...
    {
        RTreeRangeClusterClientCursorImpl(const RTreeRangeClusterClientCursorImpl &) = delete;
        RTreeRangeClusterClientCursorImpl &operator=(const RTreeRangeClusterClientCursorImpl &) = delete;
    ...
    public:
        ...
        ~RTreeRangeClusterClientCursorImpl() final;
